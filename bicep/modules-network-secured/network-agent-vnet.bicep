/*
Network Agent VNet Orchestrator (MODIFIED: passes firewallPrivateIp)
-----------------------------------------------------------
Routes to either new VNet or existing VNet module, passing through
the firewallPrivateIp for UDR + private subnet configuration.
*/
...
@description('Subscription ID of the existing VNet')
...
// ===== NEW: Firewall parameter =====
@description('Private IP of the Azure Firewall. Passed to vnet/existing-vnet modules for UDR creation.')
